...
- [vLLM 0.2 for 2x RTX 2080 Ti 22GB NVLink](https://github.com/mercury666cn/vLLM-0.2-2x2080Ti-22GB-NVLink)

本仓细目：

- [FastLLM](runtime-FastLLM.md)：中文长输入首选；官方 wheel；NVFP4 + MTP3 + 210K
- [v0.2](runtime-v0.2.md)：长输出更稳；官方 pre3 + FP8 KV；启动坑最多。v0.1 不好用（NVFP4 加载失败、主频追不上官方 100），见 v0.2 仓说明，不再单独维护
- [v0.1](runtime-v0.1.md)：历史对照，不要部署
